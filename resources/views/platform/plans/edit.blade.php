...
@section('title', __('app.edit_plan'))

@php
$pageTitle = __('app.edit_plan');
$breadcrumbs = [
...
$features   = array_values(array_filter((array) old('features', is_array($plan->features) ? $plan->features : [])));
@endphp
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" id="price" name="price" value="{{ old('price', $plan->price) }}" required
                    ...
                    <div class="form-group">
                        ...
                        <select id="currency" name="currency" class="form-control @error('currency') is-invalid @enderror" required>
                            ...
                            <option value="{{ $c }}" {{ old('currency', $plan->currency) === $c ? 'selected' : '' }}>{{ $c }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="billing_period" name="billing_period" class="form-control @error('billing_period') is-invalid @enderror" required>
                            ...
                            <option value="{{ $p }}" {{ old('billing_period', $plan->billing_period) === $p ? 'selected' : '' }}>{{ __('app.period_'.$p) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" max="365" id="trial_days" name="trial_days" value="{{ old('trial_days', $plan->trial_days) }}" required
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="form-group">
                        ...
                        <input type="number" min="1" id="max_users" name="max_users" value="{{ old('max_users', $plan->max_users) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" id="max_warehouses" name="max_warehouses" value="{{ old('max_warehouses', $plan->max_warehouses) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" id="max_products" name="max_products" value="{{ old('max_products', $plan->max_products) }}"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="number" min="0" id="sort_order" name="sort_order" value="{{ old('sort_order', $plan->sort_order) }}"
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="pf-kv">
                    ...
                    <span class="pf-kv-v">{{ $plan->created_at ? \Illuminate\Support\Carbon::parse($plan->created_at)->format('d/m/Y H:i') : '—' }}</span>
                </div>
                <div class="pf-kv">
                    <span class="pf-kv-k">{{ __('app.updated_at') }}</span>
                    <span class="pf-kv-v">{{ $plan->updated_at ? \Illuminate\Support\Carbon::parse($plan->updated_at)->format('d/m/Y H:i') : '—' }}</span>
                </div>
            </div>
        </div>
    </div>
