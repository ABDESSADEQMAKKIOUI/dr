...
<div class="card max-w-4xl">
    ...
    <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data" data-validate>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="form-group"><label class="form-label">{{ __('app.tax') }} (%)</label><input type="number" step="0.01" name="tax_rate" value="{{ old('tax_rate', $product->tax_rate ?? 0) }}" class="form-control"></div>
