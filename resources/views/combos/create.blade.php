@extends('layouts.app')
@section('title', __('app.create_combo'))
@php $pageTitle = __('app.create_combo'); $breadcrumbs = [['label'=>__('app.dashboard'),'url'=>route('dashboard')],['label'=>__('app.combo_products'),'url'=>route('combos.index')],['label'=>__('app.create')]]; @endphp
@section('content')
<div class="card max-w-4xl mx-auto">
    <div class="card-header"><h3 class="text-lg font-semibold">{{ __('app.create_combo') }}</h3></div>
    <form method="POST" action="{{ route('combos.store') }}" class="p-6 space-y-6" id="combo-form">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="sku" value="{{ old('sku') }}" class="form-input" placeholder="Auto-generated if empty">
            ...
            <div>
                ...
                <input type="number" name="price" value="{{ old('price', 0) }}" class="form-input" step="0.01" min="0" required>
        ...
        <div>
            ...
            <div id="items-container">
                <div class="item-row flex gap-3 items-end mb-2" data-index="0">
                    <div class="flex-1">
                    ...
                    <div class="w-32">
                        ...
                        <input type="number" name="items[0][quantity]" value="1" class="form-input" min="1" required>
                    </div>
